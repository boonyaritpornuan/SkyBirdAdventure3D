      ...
      <div className="flex flex-col items-center justify-center h-full">
        {phase === "ready" && (
          <>
            ...
            {/* Start button - ย้ายขึ้นมาไว้หลังลูกศร */}
            <Button
              onClick={start}
              className="pointer-events-auto bg-gradient-to-br from-orange-400 to-red-500 hover:from-orange-300 hover:to-red-400 text-white font-bold py-3 px-8 rounded-full shadow-lg transition-all hover:scale-105 animate-pulse duration-2000 text-lg sm:text-xl mb-6"
            >
              START
            </Button>
      ...
      {phase === "ended" && showGameOver && (
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            ...
            <Button
              onClick={restart}
              className="pointer-events-auto bg-gradient-to-br from-orange-400 to-red-500 hover:from-orange-300 hover:to-red-400 text-white font-['Press_Start_2P'] text-sm py-3 px-6 rounded-full mt-4 transition-all hover:scale-105"
            >
              PLAY AGAIN
            </Button>
          </div>
